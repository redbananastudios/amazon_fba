...
const KNOWN_ESTABLISHED_BRANDS = new Set([
  ...
  // Pet-care established brands
  'petsafe', 'pet safe', 'kong', 'royal canin', 'hills', "hill's",
  'purina', 'whiskas', 'pedigree', 'frontline', 'feliway', 'adaptil',
  'catit', 'cat mate', 'sureflap', 'sure petcare', 'furminator',
  'zesty paws', 'vitakraft', 'dreamies', 'felix', 'iams',
  'james wellbeloved', "lily's kitchen", 'lilys kitchen',
  'tapo', 'petkit', 'closer pets', 'ancol', 'halti', 'company of animals',
  'pets at home', 'flexi', 'ruffwear', 'hurtta', 'julius k9', 'julius-k9',
  'trixie', 'karlie', 'ferplast', 'rosewood', 'good boy', 'harringtons'
]);
...
console.log(`Phase 4 complete: ${outRows.length} products`);
console.log(`  High: ${bandCounts.High}, Medium: ${bandCounts.Medium}, Low: ${bandCounts.Low}`);
console.log(`  Fortress: ${fortressCount}`);
