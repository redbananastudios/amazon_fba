...
Supported formats:
  ...
  - Connect Beauty CSV: SKU | Manufacturer | Title | Category | Barcode | Case Size | Units Available | Unit Price (GBP) | ...
"""
import logging
import os
import re
...
_CSV_COLUMN_MAP = {
    ...
    "stock": "comments",
    "url": "url",
    # Connect Beauty mappings
    "manufacturer": "brand",
    "title": "description",
    "category": "category",
    "case size": "pack_size",
    "unit price (gbp)": "trade_price",
    "case price (gbp)": "case_price",
    "units available": "comments",
}
...
def _ingest_csv(file_path: str) -> pd.DataFrame:
    ...
    # Try UTF-8 first, fall back to cp1252 (common for UK supplier files with pound signs)
    for encoding in ("utf-8", "utf-8-sig", "cp1252", "latin-1"):
        try:
            ...
            continue
    # If all encodings fail, let pandas raise the error
